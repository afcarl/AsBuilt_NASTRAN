classdef CQUAD4class < nMAT.cardClass
    %CQUAD4 Summary of this class goes here
    ...
    properties %(Access = private)
        ...
        EID;        % Element ID
        PID;        % Property ID
        G;          % (4,1) Grid point IDs
        MCID;       % Material coord system ID
        ZOFFS;      % Z-Offset
        TFLAG;      % Specify meaning of T values
        T;          % (4,1) Membrane thickness of each grid point
    ...
    methods
        function obj = CQUAD4class(C)
            ...
            obj.G(4) = obj.getValue(C(1,f{7}));
            obj.MCID = obj.getValue(C(1,f{8}));
%             obj.ZOFFS = obj.getValue(C(1,f{9}));
        end
    end
%%  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    methods (Static)
        ...
        function writeCard(obj,fid,rlFlag)
            ...
            CS{1,7} = sprintf('%-8d',obj.G(4));
            CS{1,8} = sprintf('%-8d',obj.MCID);
